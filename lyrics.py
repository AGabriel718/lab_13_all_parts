...
print('2.')
print('On a tropical island,')
print('Underneath a molten lava moon.')
print('Hangin\' with the hula dancers,')
print('Askin\' questions cause\' they got all he answers.')
print('__________________________________________________________')
print('3.')
print("On a tropical island,\nUnderneath a molten lava moon.\nHangin' with the hula dancers,\nAskin' questions cause they have all the answers.")